...
namespace FastPlay {
	...
	public class ObjectBase {
		...
		public static ObjectBase CreateGenericInstance(Type generic_type, Type[] type_arguments, params object[] args) {
			return CreateInstance(generic_type.MakeGenericType(type_arguments), args);
		}
